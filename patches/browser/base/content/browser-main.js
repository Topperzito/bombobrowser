...
// eslint-disable-next-line no-lone-blocks
{
  ...
  if (AppConstants.MOZ_DATA_REPORTING) {
    // Data submission info bar intentionally disabled for BomboBrowser
  }
  if (!AppConstants.MOZILLA_OFFICIAL) {
    // Development helpers intentionally disabled for BomboBrowser
  }
  ...
  Services.scriptloader.loadSubScript("chrome://browser/content/bomboUpdate.js", this);
}
...
// In that case, we don't want to initialise anything, otherwise we
