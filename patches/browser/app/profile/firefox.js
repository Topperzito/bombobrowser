...
// Captive portal detection disabled for privacy.
...
// Telemetry in newtab disabled for privacy
#ifdef NIGHTLY_BUILD
...
// Telemetry settings — ALL DISABLED for maximum privacy.
...
// ---------------------------------------------------------------------------
// Maximum-privacy overrides added below
// ---------------------------------------------------------------------------

// Permanent Private Browsing mode — no history/cookies stored
pref("browser.privatebrowsing.autostart", true);

// HTTPS-Only Mode everywhere
...
// Disable network predictor and prefetch
pref("network.predictor.enabled", false);
pref("network.prefetch-next", false);

// Disable Safe Browsing (privacy tradeoff — reduces Google data collection)
...
// Pocket disabled for privacy — no data sent to getpocket.com
...
// Normandy client preferences — DISABLED for privacy
pref("app.normandy.api_url", "https://normandy.cdn.mozilla.net/api/v1");
pref("app.normandy.dev_mode", false);
pref("app.normandy.enabled", false);
pref("app.normandy.first_run", true);
pref("app.normandy.logging.level", 50); // Warn
pref("app.normandy.run_interval_seconds", 0); // Disabled — was 21600 (6 hours)
pref("app.normandy.shieldLearnMoreUrl", "https://support.mozilla.org/1/firefox/%VERSION%/%OS%/%LOCALE%/shield");
pref("app.normandy.last_seen_buildid", "");
pref("app.normandy.onsync_skew_sec", 600);
// Shield opt-out studies disabled for privacy
...
// Coverage ping is disabled by default (kept disabled for privacy).
